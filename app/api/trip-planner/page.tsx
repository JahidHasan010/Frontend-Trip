    ...
    <main className="min-h-screen font-sans">
      ...
      <header className="header-bg text-white py-12 shadow-2xl">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link href="/" passHref>
            <button className="bg-white text-gray-800 hover:bg-gray-100 border border-gray-300 font-medium py-2 px-4 rounded-lg shadow-sm hover:shadow transition flex items-center gap-2">
